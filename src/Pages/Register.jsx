...
const Register = () => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="glass-card w-full max-w-5xl mx-auto p-8 rounded-2xl relative">
        {/* Decorative corner elements */}
        <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none">
          <div className="absolute top-0 right-0 w-32 h-32 bg-neonCyan/10 blur-3xl rounded-full"></div>
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-neonPurple/10 blur-3xl rounded-full"></div>
        </div>
